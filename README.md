...
- django
    ...
    - map - contains the map-page
        - management - contains scripts for uploading data or translating property borders between coordinate systems. The scripts are run by typing python manage.py <scriptname> in the terminal
